...
void Edete_contact(Contact_node *first){
    ...
    while (loop){
        ...
        case '3':
            ...
            while (true){
                cout<<"-Enter code phone for edete :";
                cin>>pmenu;
                if(pmenu > count) cout<<"error! :not match code\n";
                else {
                    ...
                    if(Check_phone(Details_edete)){ 
                        ...
                        if(sure == 'y'){
                            ...
                            Write_phones_fille(Search->pnode);
                        }
                    }
                }
            }
